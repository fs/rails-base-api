if defined? Apitome
  Apitome.setup do |config|
    ...
    config.title = "#{Rails.application.class.parent_name.titleize} V1"

    # The main layout view for all documentation pages. By default this is pretty basic, but you may want to use your
    ...
    # This allows you to override the javascript manually. You typically want to require `apitome/application` within
    # the override, but if you want to override it entirely you can do so.
